...
export default function Home () {
  ...
  const bio = `<p>Hi, my name is Kevin. During my life I have lived in: Chicago, Milwaukee, and Naples, Florida.</p> <p> I've known how to code since a young age, and worked at a couple of early stage startups during college.</p> <p> Around a year ago I got into the phenomenon that is web3, and I haven't looked back.</p>
