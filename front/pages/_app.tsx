          ...
          <Header height={50} p="m">
            {
              <Grid ml={10}>
                ...
                <Grid.Col mt={5} offset={3} span={5}>
                  ...
                  <Button mr={10} size="sm" variant="gradient" gradient={{ from: 'red', to: 'yellow', deg: 120 }}>Blogs</Button>
    </Link>

    <Link href="/projects" passHref legacyBehavior>
                  <Button size="sm" variant="gradient" gradient={{ from: 'red', to: 'yellow', deg: 120 }}>Projects</Button>
    </Link>
